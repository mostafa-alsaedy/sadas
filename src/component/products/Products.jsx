...
import { FavouriteContext } from "../../context/FavProductsContext";
import Responsive from "../CategorySlider/CategorySlider";
import { Helmet } from "react-helmet";
import WhishList from "../../customhook/useGetWhishlist";
// import useAddWhishlist from "../../customhook/useAddWhishlist";
...
export default function Products() {
  ...
  // console.log(WhishlistDataId);

  // const { mutateAsync } = useAddWhishlist();
  ...
  const { addProductToWishlist } = useContext(FavouriteContext);

  async function handleProductToWishlist(id) {
    const respFlags = await addProductToWishlist(id);
    console.log(respFlags);
          ...
          {data.data.data.map((product) => (
            ...
            >
              ...
              <div className="relative overflow-hidden group ">
                ...
                <div
                  onClick={() => {
                    handleProductToWishlist(product._id);
                  }}
  ...
  // const allSharedData = useContext(provider);
  // console.log(allSharedData);

  /* <>----------------</> */

  // const { counter } = useContext(counterProvider);
  // console.log(counter);

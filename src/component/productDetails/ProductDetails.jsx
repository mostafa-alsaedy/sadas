...
export default function ProductDetails() {
  ...
  return (
    <div className=" container mx-auto p-5 flex items-center justify-between my-[13vh]">
      <div className=" w-1/4">
        <img
          src={Data.imageCover}
          alt={Data.title}
      ...
      <div className=" w-[70%] font-serif font-semibold">
        {/* <h1>{Data.title}</h1> */}
        <h2 className="text-lg text-left mx-1 text-sky-600 font-serif ">
          <span className="text-slate-500 font-semibold"> Title: </span>{" "}
          {Data.title}.
        </h2>
        <p className=""></p>

        <h5 className="text-lg text-left mx-1 text-sky-600 font-serif  ">
        ...
        <p className="text-lg text-left mx-1 text-sky-600 font-serif  ">

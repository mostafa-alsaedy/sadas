...
export default function Register() {
  ...
  return (
    <>
      {" "}
      <div className="h-full relative w-full flex flex-col  justify-center items-center mt-[11vh] bg-sky-950 ">
        <Helmet>
          <title>Sign up</title>
        ...
        {success ? (
          <div
            className="relative   mt-[9vh] text-center w-[500px] h-fit m-3 p-4 mb-4 text-red-800 rounded-lg bg-yellow-50 font-bold dark:bg-slate-300 dark:text-green-500"
            role="alert"
          >
            Success!
          </div>
        ...
        {error ? (
          <div
            className="relative  mt-[9vh] text-center w-[700px] h-fit m-3 p-4 mb-4  text-red-800 rounded-lg bg-yellow-50 font-bold dark:bg-red-100 dark:text-red-500"
            role="alert"
          >
            {error}
          </div>
